...
def get_starter_df(player_id, year): 
    ...
    df = pd.read_sql(text(f"SELECT b.game_id, b.game_date, b.home_team, b.away_team, b.home_score, b.away_score, (a.atbats)atBats, "
            ...
            f"a.strikes, a.triples, a.whip, a.wins FROM pitcher_table a LEFT JOIN game_table b ON a.game_id = b.game_id WHERE a.playerid = '{player_id}' AND b.game_date LIKE '{year}%%' ORDER BY game_date DESC;"), con = engine)
