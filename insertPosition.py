...
for game in res_game:
    ...
    for batter in awayBatters:
        if batter['personId'] != 0 and batter['substitution'] == False:
            if batter['position'] == 'C':
                away_c = batter['name'].replace("'", " ")
            elif batter['position'] == '1B':
                away_b1 = batter['name'].replace("'", " ")
            elif batter['position'] == '2B':
                away_b2 = batter['name'].replace("'", " ")
            elif batter['position'] == '3B':
                away_b3 = batter['name'].replace("'", " ")
            elif batter['position'] == 'SS':
                away_ss = batter['name'].replace("'", " ")
            elif batter['position'] == 'LF':
                away_lf = batter['name'].replace("'", " ")
            elif batter['position'] == 'CF':
                away_cf = batter['name'].replace("'", " ")
            elif batter['position'] == 'RF':
                away_rf = batter['name'].replace("'", " ")
            elif batter['position'] == 'DH':
                away_dh = batter['name'].replace("'", " ")
    ...
    for batter in homeBatters:
        if batter['personId'] != 0 and batter['substitution'] == False:
            if batter['position'] == 'C':
                home_c = batter['name'].replace("'", " ")
            elif batter['position'] == '1B':
                home_b1 = batter['name'].replace("'", " ")
            elif batter['position'] == '2B':
                home_b2 = batter['name'].replace("'", " ")
            elif batter['position'] == '3B':
                home_b3 = batter['name'].replace("'", " ")
            elif batter['position'] == 'SS':
                home_ss = batter['name'].replace("'", " ")
            elif batter['position'] == 'LF':
                home_lf = batter['name'].replace("'", " ")
            elif batter['position'] == 'CF':
                home_cf = batter['name'].replace("'", " ")
            elif batter['position'] == 'RF':
                home_rf = batter['name'].replace("'", " ")
            elif batter['position'] == 'DH':
                home_dh = batter['name'].replace("'", " ")
