...
#                                 VALUES('{gameid}', '{gamedate}', '{index}', '{int(row['player_id'])}', '{row['career_atBats']}', '{row['career_avg']}', '{row['career_homeRuns']}', '{row['career_obp']}', '{row['career_ops']}', '{row['career_rbi']}', '{row['career_slg']}', '{row['career_strikeOuts']}', '{row['recent_atBats']}', '{row['recent_avg']}', '{row['recent_homeRuns']}', '{row['recent_obp']}', '{row['recent_ops']}', '{row['recent_rbi']}', '{row['recent_slg']}', '{row['recent_strikeOuts']}');"))
...
#                                 VALUES('{gameid}', '{gamedate}', '{index}', '{int(row['player_id'])}', '{row['career_era']}', '{row['career_homeRuns']}', '{row['career_whip']}', '{row['career_battersFaced']}', '{row['recent_era']}', '{row['recent_homeRuns']}', '{row['recent_whip']}', '{row['recent_battersFaced']}');"))