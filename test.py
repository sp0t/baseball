...
engine.execute(f"INSERT INTO win_percent_c(game_id, away_prob, home_prob) VALUES('{717381}', '{pred_1a[0]}', '{pred_1a[1]}') ON CONFLICT win_percent_c_game_id_key DO UPDATE SET away_prob = excluded.away_prob, home_prob = excluded.home_prob;")  
