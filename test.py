...
engine.execute(f"INSERT INTO win_percent_c(game_id, away_prob, home_prob) VALUES('{717361}', '{pred_1a[0]}', '{pred_1a[1]}') ON CONFLICT (game_id) DO UPDATE SET away_prob = excluded.away_prob, home_prob = excluded.home_prob;")  
