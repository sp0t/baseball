...
print(pred_1b)
engine.execute(f"INSERT INTO win_percent(game_id, away_prob, home_prob) VALUES('{717381}', '{pred_1b['away_prob']}', '{pred_1b['home_prob']}') ON CONFLICT (game_id) DO UPDATE SET away_prob = excluded.away_prob, home_prob = excluded.home_prob;")  
