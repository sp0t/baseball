...
print(home_starter_data)
# Bullpen 
away_bullpen_data = process_bullpen_data('MIN', 'away', '2023/07/18')
home_bullpen_data = process_bullpen_data('SEA', 'home', '2023/07/18')
...
engine.execute(f"INSERT INTO win_percent_c(game_id, away_prob, home_prob) VALUES('{717350}', '{pred_1a[0]}', '{pred_1a[1]}') ON CONFLICT (game_id) DO UPDATE SET away_prob = excluded.away_prob, home_prob = excluded.home_prob;")  
