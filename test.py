...
batter_name = ['Aaron Civale', 'Amed Rosario', 'Andres Gimenez']
pitcher_name = ['Angel Martinez']
# game_id = '715720'
...
res = pd.read_sql(f"SELECT * FROM schedule WHERE away_name = '{away_name}' and home_name = '{home_name}'", con = engine).iloc[0]
game_id = res['game_id']
